...
func prepareEmail() *Email {
	e := NewEmail()
	e.From = "Aman Raj <test@example.com>"
...
func basicTests(t *testing.T, e *Email) *mail.Message {
	...
	expectedHeaders := map[string]string{
		"To":      "<test@example.com>",
		"From":    "\"Aman Raj\" <test@example.com>",
...
func TestEmailFromReader(t *testing.T) {
	ex := &Email{
		...
		To:      []string{"Aman Raj <iamanraj28@gmail.com>", "also@example.com"},
		From:    "Aman Raj <iamanraj28@gmail.com>",
		ReplyTo: []string{"Aman Raj <iamanraj28@gmail.com>"},
...
Subject: Test Subject
From: Aman Raj <iamanraj28@gmail.com>
Reply-To: Aman Raj <iamanraj28@gmail.com>
To: Aman Raj <iamanraj28@gmail.com>, also@example.com
...
func TestBase64EmailFromReader(t *testing.T) {
	ex := &Email{
		Subject: "Test Subject",
		To:      []string{"Aman Raj <iamanraj28@gmail.com>"},
		From:    "Aman Raj <iamanraj28@gmail.com>",
...
Subject: Test Subject
From: Aman Raj <iamanraj28@gmail.com>
To: Aman Raj <iamanraj28@gmail.com>
Content-Type: multipart/alternative; boundary=001a114fb3fc42fd6b051f834280
...
func ExampleGmail() {
	e := NewEmail()
	e.From = "Aman Raj <test@gmail.com>"
	e.To = []string{"test@example.com"}
	e.Bcc = []string{"test_bcc@example.com"}
	e.Cc = []string{"test_cc@example.com"}
	e.Subject = "Awesome Subject"
